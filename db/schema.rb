...
ActiveRecord::Schema[7.1].define(version: 2025_12_09_065854) do
  ...
  create_table "delivery_plan_items", force: :cascade do |t|
    ...
    t.bigint "company_id"
    t.bigint "own_location_id"
    t.index ["company_id"], name: "index_delivery_plan_items_on_company_id"
    t.index ["delivery_plan_id"], name: "index_delivery_plan_items_on_delivery_plan_id"
    t.index ["order_id"], name: "index_delivery_plan_items_on_order_id"
    t.index ["own_location_id"], name: "index_delivery_plan_items_on_own_location_id"
    t.index ["restaurant_id"], name: "index_delivery_plan_items_on_restaurant_id"
