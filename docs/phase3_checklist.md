...
#### 管理画面：配送割当
- [x] Admin::DeliveryAssignmentsController作成
- [x] 配送割当一覧画面 (/admin/delivery_assignments)
  - 日別・配送会社別フィルター
  - 配送ステータス表示
  - 担当者割当ボタン
- [x] 配送割当編集画面
...
#### テスト作成
- [x] spec/models/delivery_assignment_spec.rb
- [x] spec/services/assign_delivery_service_spec.rb
- [x] spec/requests/admin/delivery_assignments_spec.rb
...
#### 配送担当者向けレイアウト作成
- [x] app/views/layouts/delivery_application.html.erb
  - モバイル最適化ヘッダー
  - ハンバーガーメニュー
...
- [x] Delivery::AssignmentsController#index
  - 配送担当者の配送予定取得
  - 日付フィルター（今日、明日、週間）
  - ステータスフィルター
- [x] ビュー作成
...
- [x] Delivery::AssignmentsController#show
  - 配送詳細情報取得
- [x] ビュー作成
  - 配送先情報表示
  - 商品情報表示
...
- [x] スマホ表示最適化（375px〜）
- [x] タブレット表示最適化（768px〜）
- [x] タッチ操作最適化（ボタンサイズ、間隔）

#### テスト作成
- [x] spec/requests/delivery/assignments_spec.rb
- [x] spec/features/delivery/assignments_spec.rb
  - 配送予定一覧表示
  - 日付フィルター動作
  - ステータスフィルター動作
  - 配送詳細表示
...
- [x] Delivery::ReportsController#new
  - 配送報告フォーム表示
- [x] Delivery::ReportsController#create
  - 配送報告作成
  - 写真アップロード
  - 位置情報記録
- [x] ビュー作成
...
#### テスト作成
- [x] spec/models/delivery_report_spec.rb
- [x] spec/requests/delivery/reports_spec.rb
- [x] spec/features/delivery/reports_spec.rb
  - 配送完了報告フロー
  - 写真アップロードフロー
  - 問題報告フロー
